...
public class ModelOryx extends ModelBase {
	...
	public ModelRenderer Bob_1;
	public ModelRenderer Bob_2;
	public ModelRenderer Bob_3;
	...
	public ModelOryx() {
		...
		this.RightLegFront01.setRotationPoint(-2.5F, 3.5F, -3.3F);
		this.RightLegFront01.addBox(-1.5F, -1.0F, -2.0F, 3, 7, 4, 0.0F);
		this.setRotateAngle(RightLegFront01, -0.045553093477052F, 0.0F, 0.0F);
		...
		this.setRotateAngle(RightLegBack03, -0.6829473363053812F, 0.0F, 0.0F);
		...
		this.LeftLegFront01.setRotationPoint(2.5F, 3.5F, -3.3F);
		this.LeftLegFront01.addBox(-1.5F, -1.0F, -2.0F, 3, 7, 4, 0.0F);
		this.setRotateAngle(LeftLegFront01, -0.045553093477052F, 0.0F, 0.0F);
		...
		this.Bob = new ModelRenderer(this, 14, 36);
		this.Bob.setRotationPoint(0.0F, 1.8F, 7.0F);
		this.Bob.addBox(-1.0F, -1.0F, -1.0F, 2, 3, 2, 0.0F);
		this.setRotateAngle(Bob, 0.7330382858376184F, 0.0F, 0.0F);
		...
		this.setRotateAngle(LeftLegBack02, 1.0471975511965976F, 0.0F, 0.0F);
		this.Bob_1 = new ModelRenderer(this, 22, 34);
		this.Bob_1.setRotationPoint(0.0F, 1.5F, 0.0F);
		this.Bob_1.addBox(-1.5F, -0.5F, -1.5F, 3, 3, 3, 0.0F);
		this.setRotateAngle(Bob_1, -0.36425021489121656F, 0.0F, 0.0F);
		...
		this.setRotateAngle(RightLegBack02, 1.0471975511965976F, 0.0F, 0.0F);
		...
		this.setRotateAngle(LeftLegBack01, -0.045553093477052F, 0.0F, 0.0F);
		...
		this.setRotateAngle(RightLegBack01, -0.045553093477052F, 0.0F, 0.0F);
		...
		this.setRotateAngle(LeftLegFront03, 0.27314402793711257F, 0.0F, 0.0F);
		...
		this.setRotateAngle(LeftLegBack03, -0.6829473363053812F, 0.0F, 0.0F);
		this.RightLegFront02 = new ModelRenderer(this, 0, 31);
		this.RightLegFront02.mirror = true;
		this.RightLegFront02.setRotationPoint(-0.2F, 5.0F, 0.0F);
		this.RightLegFront02.addBox(-1.01F, -1.0F, -1.5F, 2, 6, 3, 0.0F);
		this.setRotateAngle(RightLegFront02, -0.36425021489121656F, 0.0F, 0.0F);
		...
		this.setRotateAngle(RightLegFront03, 0.27314402793711257F, 0.0F, 0.0F);
		this.Bob_3 = new ModelRenderer(this, 30, 40);
		this.Bob_3.setRotationPoint(0.0F, 2.5F, 0.0F);
		this.Bob_3.addBox(-1.0F, 0.0F, -1.0F, 2, 5, 2, 0.0F);
		...
		this.LeftLegFront02.setRotationPoint(0.2F, 5.0F, 0.0F);
		this.LeftLegFront02.addBox(-0.99F, -1.0F, -1.5F, 2, 6, 3, 0.0F);
		this.setRotateAngle(LeftLegFront02, -0.36425021489121656F, 0.0F, 0.0F);
		...
		this.Bob_2 = new ModelRenderer(this, 34, 34);
		this.Bob_2.setRotationPoint(0.0F, 2.5F, 0.0F);
		this.Bob_2.addBox(-1.5F, 0.0F, -1.5F, 3, 2, 3, 0.0F);
		...
		this.Bob_1.addChild(this.Bob_3);
		...
		this.Bob_1.addChild(this.Bob_2);
