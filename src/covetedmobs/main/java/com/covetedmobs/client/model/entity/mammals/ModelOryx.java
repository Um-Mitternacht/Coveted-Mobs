...
public class ModelOryx extends ModelBase {
	...
	public ModelOryx() {
		...
		this.Head.setRotationPoint(0.01F, -2.9F, -5.3F);
		this.Head.addBox(-2.0F, -0.6F, -4.0F, 4, 4, 4, 0.0F);
		...
		this.RightLegFront01.setRotationPoint(-2.5F, 3.2F, -3.3F);
		this.RightLegFront01.addBox(-1.5F, -1.0F, -2.0F, 3, 7, 4, 0.0F);
		this.setRotateAngle(RightLegFront01, -0.08726646259971647F, 0.0F, 0.0F);
		this.LeftFlapper = new ModelRenderer(this, 90, 24);
		this.LeftFlapper.setRotationPoint(1.7F, -0.3F, -0.5F);
		...
		this.Neck.addBox(-2.0F, -3.0F, -5.5F, 4, 5, 8, 0.0F);
		this.setRotateAngle(Neck, -0.4553564018453205F, -0.004014257279586958F, 0.0F);
		...
		this.LeftLegFront01.setRotationPoint(2.5F, 3.2F, -3.3F);
		this.LeftLegFront01.addBox(-1.5F, -1.0F, -2.0F, 3, 7, 4, 0.0F);
		this.setRotateAngle(LeftLegFront01, -0.08726646259971647F, 0.0F, 0.0F);
		this.RightScimitar01 = new ModelRenderer(this, 65, 42);
		this.RightScimitar01.mirror = true;
		this.RightScimitar01.setRotationPoint(-1.5F, -0.5F, 0.0F);
		...
		this.ShoulderBaby = new ModelRenderer(this, 1, 42);
		this.ShoulderBaby.setRotationPoint(0.0F, 0.3F, 0.0F);
		this.ShoulderBaby.addBox(-3.0F, -0.5F, -7.0F, 6, 8, 8, 0.0F);
		this.setRotateAngle(ShoulderBaby, -0.091106186954104F, 0.0F, 0.0F);
		...
		this.DewlapAdult = new ModelRenderer(this, 80, 5);
		this.DewlapAdult.setRotationPoint(0.0F, 1.0F, -2.0F);
		this.DewlapAdult.addBox(-1.0F, -1.0F, -3.0F, 2, 3, 8, 0.0F);
		...
		this.Snout01.setRotationPoint(0.0F, 1.4F, -4.0F);
		...
		this.TorsoBaby = new ModelRenderer(this, 29, 42);
		...
		this.BumBaby = new ModelRenderer(this, 59, 48);
		...
		this.LeftScimitar01.setRotationPoint(1.5F, -0.5F, 0.0F);
		...
		this.RightFlapper.setRotationPoint(-1.7F, -0.3F, -0.5F);
