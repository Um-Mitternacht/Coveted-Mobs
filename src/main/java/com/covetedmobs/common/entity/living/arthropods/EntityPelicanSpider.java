...
public class EntityPelicanSpider extends ModEntityTameable {
    ...
    protected static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityPelicanSpider.class, DataSerializers.BOOLEAN);
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(3, new EntityAITargetNonTamed<>(this, EntityLivingBase.class, true, e -> e instanceof EntitySpider || e instanceof EntityCaveSpider));
