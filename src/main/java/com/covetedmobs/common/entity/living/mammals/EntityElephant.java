...
public class EntityElephant extends ModEntityTameableGrazer {
    ...
    protected static final DataParameter<Integer> GRAZE_TIME = EntityDataManager.createKey(EntityElephant.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> ELEPHANT_TYPE = EntityDataManager.createKey(EntityElephant.class, DataSerializers.VARINT);
    ...
    public int getElephantType() {
        return this.dataManager.get(ELEPHANT_TYPE).intValue();
    }
