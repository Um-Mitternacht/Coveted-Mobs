...
public class EntityOryx extends ModEntityAnimal {
    protected static final DataParameter<Integer> GRAZE_TIME = EntityDataManager.createKey(EntityOryx.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityOryx.class, DataSerializers.BOOLEAN);
